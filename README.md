...
- 应用程序可在右侧 ```bash[Releases](https://github.com/VerdantMountain/KL-Mining-System/releases)``` 中下载（上方 <img src="https://img.shields.io/badge/code-brightgreen"/> 按钮中点击 `Download ZIP` 可下载工程文件）
