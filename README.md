...
- 矿龙软件，必是精品，矿龙智能挖矿系统，最好用的智能挖矿系统，网吧，网咖，电竞游戏馆，游戏工作室最好用的挖矿系统
...
- **智能优化**：软件可以配置挖矿程序的参数并有自动算法调节功能，最大限度的保证了机器的无影响运行
...
支持矿池子账户钱包挖矿
优化了软件版本的算法，版本识别更准确
改进了进程识别的程序算法，最大支持暂停和退出功能总计1000个字节的进程名称排除量，并做出了进程暂停和退出的高级界面
改进了软件挖矿强度的计算算法
